...
VERSION="0.0"
## HR: Version 2.3.4 Latest commit: March 05, 2019
## Github link: https://github.com/ANTsX/ANTs/blob/v2.3.4/Scripts/antsBrainExtraction.sh
  ...
  then
    ...
    if [[ ! -f ${EXTRACTION_INVERSE_WARP} ]];
      then
        ...
        ## JNL 7/19/21 - changed from 1 mm to 0.35 mm
        ### JNL 10/8/21 - testing 1mm again on 0.33mm iso resampled T1s vs. 0.35mm resampling
        ### JNL 10/25/21 - testing 0.35mm again on unresampled brains
        ## JNL 9/12/23 - testing 0.5mm - maybe the small spacing was not helping with convergence
        ## JNL 9/13/23 - back to 0.35mm
        
          logCmd ${ANTSPATH}/ResampleImageBySpacing ${DIMENSION} ${EXTRACTION_TEMPLATE} ${EXTRACTION_INITIAL_AFFINE_FIXED} 0.35 0.35 0.35 1
          logCmd ${ANTSPATH}/ResampleImageBySpacing ${DIMENSION} ${N4_CORRECTED_IMAGES[0]} ${EXTRACTION_INITIAL_AFFINE_MOVING} 0.35 0.35 0.35 1
